...
LikertSingleStimulusPage.prototype.init = function (_callbackError) { 
  ...
  if (this.pageConfig.mustRate === false) {
    ...
    this.likert1 = new LikertScale(this.pageConfig.response, "1_", this.pageConfig.mustPlayback == true, cbk);
    this.likert2 = new LikertScale(this.pageConfig.response, "2_", this.pageConfig.mustPlayback == true, cbk); 
    this.likert3 = new LikertScale(this.pageConfig.response, "3_", this.pageConfig.mustPlayback == true, cbk);
    this.likert4 = new LikertScale(this.pageConfig.response, "4_", this.pageConfig.mustPlayback == true, cbk); 
...
LikertSingleStimulusPage.prototype.render = function (_parent) {  
  ...
  if(this.pageConfig.question1 === null){
    ...
    content = this.pageConfig.question1;
  }
  var p = $("<p>" + content + "</p>");
  div.append(p);
