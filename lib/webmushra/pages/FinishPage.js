        ...
        if (trial.type === "mushra") {
	        ...
	        trEmpty = $("<tr height='8px'></tr>");
	     	...
	     	for(j = 0; j < trial.responses.length; ++j){
	     		...
	     		tdRating1 = document.createElement("td");
			tdRating2 = document.createElement("td");			
	     		tdRating3 = document.createElement("td");
                        tdRating4 = document.createElement("td");

	     		$(tdStimuli).append(trial.responses[j].stimulus + ": ");
	     		$(tdRating1).append(trial.responses[j].stimulusRating1);
	     		$(tdRating2).append(trial.responses[j].stimulusRating2);
	     		$(tdRating3).append(trial.responses[j].stimulusRating3);
	     		$(tdRating4).append(trial.responses[j].stimulusRating4);

	     		$(trLSS).append(tdStimuli);
	     		$(trLSS).append(tdRating1);
	     		$(trLSS).append(tdRating2);
	     		$(trLSS).append(tdRating3);
	     		$(trLSS).append(tdRating4);
	     		$(table).append(trLSS);
	     	}
	     }
