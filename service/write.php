...
array_push($input,  "trial_id", "stimuli_rating1", "stimuli_rating2", "stimuli_rating3", "stimuli_rating4", "stimuli", "rating_time");
...
foreach($session->trials as $trial) {
	...
	if($trial->type == "likert_single_stimulus") {
		foreach ($trial->responses as $response) {
			...
			array_push($results,  $trial->id, "$response->stimulusRating1", "$response->stimulusRating2", "$response->stimulusRating3", "$response->stimulusRating4", $response->stimulus, $response->time);
